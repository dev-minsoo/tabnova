...
![탭 검색과 탐색이 가능한 TabNova 사이드패널](docs/tabnova1.png)

세로형 탭 목록에서 열린 탭을 빠르게 훑고, 검색으로 즉시 좁혀가며, 관련 작업을 Chrome 사이드패널 안에서 정리할 수 있습니다.

### 설정

![언어, 테마, 강조색 옵션을 보여주는 TabNova 설정 화면](docs/tabnova2.png)

전용 설정 화면에서 언어, 컬러 모드, 강조색, 확장 동작 관련 옵션을 조정할 수 있습니다.
